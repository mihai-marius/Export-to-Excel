In order for this to work you will have to instal the packeage from Laravel Excel. Require this package in the composer.json of your Laravel project. This will download the package and PhpSpreadsheet.
